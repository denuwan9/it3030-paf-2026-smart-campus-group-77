...
const TicketItemCard = ({ id, title, location, reporter, category, attachmentsCount, commentsCount, status, priority, onClick, theme = 'dark' }) => {
  ...
  return (
    <div 
      onClick={onClick}
      className={`${isLight ? 'bg-white border border-slate-200 hover:border-blue-300 hover:shadow-md' : 'bg-[#171717] border border-white/5 hover:bg-[#1c1c1c]'} p-6 rounded-2xl shadow-sm transition-all group cursor-pointer`}
    >
