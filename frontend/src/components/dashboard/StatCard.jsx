...
const StatCard = ({ label, value, icon: Icon, colorClass, trend, delay = 0 }) => (
  <motion.div 
    ...
    className="bg-white border border-slate-100 p-6 rounded-[2rem] shadow-nexer-sm overflow-hidden relative group transition-all"
  >
    ...
    <div className="space-y-1">
      ...
      <div className="flex items-baseline gap-2">
        <h3 className="text-3xl font-black text-nexer-text-header tracking-tight group-hover:text-nexer-brand-primary transition-colors">{value}</h3>
