          ...
          <div className="flex-1 flex flex-col justify-center items-center gap-10">
            ...
            <div className="space-y-8">
              ...
              <div className="flex justify-center gap-2 mt-6">
                <div className="w-8 h-2 bg-nexar-brand-primary rounded-full" />
        ...
        <div className="w-full md:w-1/2 p-6 sm:p-8 lg:p-12 flex flex-col justify-center relative bg-white">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-1">
                <div className="flex justify-between px-1">
                  ...
                  <Link 
                    to="/forgot-password" 
                    className="text-sm font-bold text-slate-400 hover:text-nexar-brand-primary transition-colors"
                  >
                    Forgot?
                  </Link>
                </div>
              ...
              <div className="space-y-4 pt-2">
                ...
                >
                  {googleLoading ? (
                    <Loader2 className="w-5 h-5 animate-spin text-nexar-brand-primary" />
                  ) : (
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-500 font-medium">
              Are you new?{' '}
              <Link to="/register" className="text-nexar-brand-primary font-black hover:underline underline-offset-4">
                Create Account
              </Link>
            </p>
          </div>
