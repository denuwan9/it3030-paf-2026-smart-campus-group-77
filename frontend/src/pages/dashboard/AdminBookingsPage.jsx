    ...
    <div className="bg-transparent min-h-[calc(100vh-80px)] font-sans text-slate-600">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="rounded-xl p-5 border border-amber-200 bg-gradient-to-br from-amber-50 to-white shadow-sm flex flex-col justify-between h-28 hover:-translate-y-1 hover:shadow-md hover:scale-105 transition-all duration-300">
          ...
          <div className="rounded-xl p-5 border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white shadow-sm flex flex-col justify-between h-28 hover:-translate-y-1 hover:shadow-md hover:scale-105 transition-all duration-300">
