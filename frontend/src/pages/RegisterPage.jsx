  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 p-3 sm:p-6 lg:p-8">
      ...
      >
        ...
        <div className="w-full md:w-1/2 p-5 sm:p-8 lg:p-14 flex flex-col relative bg-white overflow-y-auto max-h-[min(800px,90vh)]">
          <div className="mb-6 flex flex-col items-start gap-4 sm:gap-6">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl lg:text-4xl font-black text-slate-900 tracking-tight mb-1 sm:mb-2 text-left">
                Create an Account
              </h1>
